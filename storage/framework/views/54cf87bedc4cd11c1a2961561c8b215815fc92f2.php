	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				<?php if(Auth::user()->hasRole('client') || Auth::user()->hasRole('admin')): ?>
				<li class="treeview">
					<a href="#">
				...
				<?php endif; ?>
				<?php if(Auth::user()->hasRole('product') || Auth::user()->hasRole('admin')): ?>
				<li class="treeview">
					<a href="#">
				...
				<?php endif; ?>
				<?php if(Auth::user()->hasRole('labour') || Auth::user()->hasRole('admin')): ?>
				<li class="treeview">
					<a href="#">
				...
				<?php endif; ?>
				<?php if(Auth::user()->hasRole('quote') || Auth::user()->hasRole('admin')): ?>
				<li class="treeview">
					<a href="#">
				...
				<?php endif; ?>
				<?php if(Auth::user()->hasRole('invoice') || Auth::user()->hasRole('admin')): ?>
				<li class="treeview">
					<a href="#">
